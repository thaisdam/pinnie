...
public class SearchService {
    ...
    public SearchService(PinRepository pinRepository) {
        this.pinRepository = pinRepository;
    }

    @Transactional(readOnly = true)
    public Slice<PinResponseDTO> searchPins(String query, Pageable pageable) {
        Slice<Pin> pins = pinRepository.findByTitleContainingIgnoreCaseOrDescriptionContainingIgnoreCaseOrderByCreatedAtDesc(
